...
TEMPLATE_DIR = os.path.join(BASE_DIR, 'portfolio/templates')
...
SECRET_KEY = 'q-50-%j-@ek_=tm-()%b+k2d$&8j_+$684&kpofia3yeq9kpei'
...
EMAIL_HOST_USER = 'manish.bbps@gmail.com'
EMAIL_HOST_PASSWORD = 'opzxwujiutevmmin'
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False